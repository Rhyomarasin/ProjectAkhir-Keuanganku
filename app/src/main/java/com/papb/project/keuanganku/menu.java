...
public class menu extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tittle = "Hello!!";
        String isi = "please enjoy our app";
        String appName = "keuanganku";
        notif notif = new notif();
        notif.sendNotif(tittle,isi,appName,this);
        ...
        if(sessionManagement.isLoggedIn()) {
            ...
            int i = 0;
            int e = 0;
            //mengambil jumlah ic_menu_income user dari sqlite
            ...
            int total = i-e; //total diperoleh dari ic_menu_income - expenses
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_incomegraf) {
            Intent i = new Intent(getApplicationContext(), GraphIncome.class);
            startActivity(i);
